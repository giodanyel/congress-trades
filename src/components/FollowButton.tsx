...
export function FollowButton({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1.5 rounded-full border font-medium transition-all duration-150 hover:scale-105 active:scale-95 disabled:opacity-60 ${sizeClasses} ${
        following
          ? "border-amber-300 bg-amber-50 text-amber-700 shadow-sm dark:border-amber-800 dark:bg-amber-950 dark:text-amber-300"
    ...
    >
      <svg
        viewBox="0 0 20 20"
        className={`transition-transform duration-200 ${following ? "scale-110" : ""} ${size === "sm" ? "h-3.5 w-3.5" : "h-4 w-4"}`}
